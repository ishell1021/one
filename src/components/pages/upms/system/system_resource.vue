    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                <el-select v-model="searchData.systemType" placeholder="请选择资源类型" class="handle-select mr10">
                    <el-option v-for="item in systemTypeList" :key="item.paraValue" :label="item.paraShowMsg" :value="item.paraValue"></el-option>
                </el-select>
                <el-input v-model="searchData.systemNameOrId" placeholder="请输入资源名称/ID" class="handle-input mr10"></el-input>
                <el-button type="primary"  @click="reset">重置</el-button>
                <el-button type="primary" icon="el-icon-search" @click="search">查询</el-button>
            </div>
            <el-table :data="tableData" border style="width: 100%" ref="multipleTable" @row-click="saveItem">
                <el-table-column prop="systemName" label="资源名称" align="center">
                </el-table-column>
                <el-table-column prop="systemType" label="资源类型" align="center" :formatter="systemTypeFormatter">
                </el-table-column>
    ...
    export default {
        data() {
            return {
                ...
                dropdownList: [
                  { title: '编辑', description: 'sysResource_edit', },
                  { title: '暂停', description: 'handlePause', },
                  { title: '恢复', description: 'handleRenew', },
                  { title: '关联角色', description: 'sysResource_role', },
                ]
            }
        },
        created() {
